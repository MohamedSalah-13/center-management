 ...
 *
 * <p>يحلّ محل {@code AlertUtils} من fx-commons. المكتبة مُصدَّرة كـ jar جاهز داخل {@code lib/}
 * وواجهتها خمس دوال ساكنة بلا أي منفذ لضبط الاتجاه أو نصوص الأزرار، فكانت نوافذها تُرسم
 * من اليسار لليمين وبأزرار OK/Cancel مهما كانت لغة البرنامج.</p>
 *
