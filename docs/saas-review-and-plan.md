...
**الحال الآن:** بقي البند 3 — `MoneyUtils`. الوحدة قائمة والحزم فيها، ومعيار الانتهاء
محقَّق: `center-app` يُجمَّع ويُختبر بلا `javafx-*` في شجرة اعتمادياته، والـ Desktop يعمل كما
كان، ولا استثناء في حارس الطبقة. وما تبقّى ليس تنظيفاً للحدّ بل تبديلُ مصدرٍ خلف واجهة، كما
كان البند 2: العملة ساكنة اليوم لأن السنتر واحد، وعلى خادمٍ تُقرأ لكل مؤسسة.
...
وهي منجزة كلها اليوم، ومعها 7 و8 و10 و1 و2 وإن لم تكن في هذه القائمة.
