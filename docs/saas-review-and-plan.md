...
**الحال الآن:** البنود 4 و5 و6 و7 و8 و9 و10 منجزة، وبقيت 1 و2 و3 — وهي الفصل نفسه (`center-app`)
و`I18n` و`MoneyUtils`. الحزم الأربع خالية اليوم من `javafx` و`java.awt` وتفضيلات الجهاز، يحرسها
`BusinessLayerPurityTest` بلا استثناء واحد؛ فما بقي هو إنشاء الوحدة ونقل الحزم إليها، لا تنظيفها.
